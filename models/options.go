...
type StableDiffusionOptions struct {
	...
	UpscalerForImg2Img                 any      `json:"upscaler_for_img2img,omitempty"`
	SCUNETTile                         *float64 `json:"SCUNET_tile,omitempty"`
	SCUNETTileOverlap                  *float64 `json:"SCUNET_tile_overlap,omitempty"`
	...
	DisabledExtensions                 []any    `json:"disabled_extensions,omitempty"`
...
func (s *StableDiffusionOptions) String() string {
